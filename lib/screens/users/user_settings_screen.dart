                ...
                delegate: SliverChildListDelegate([
                          ...
                          rxImageController.pickedImages.isNotEmpty
                              ...
                              : buildImageCircle(
                                  rxUserController.currentUser.value!.avatar ==
                                              null ||
                                          rxUserController.currentUser.value!
                                              .avatar!.isEmpty
                                      ? ''
                                      : rxUserController
                  ...
                  Padding(
                    ...
                    child: buildElevatedButtonIcon(
                        ...
                        onPressed: () async {
                          // Uploader limage
                          if (rxImageController.pickedImages.isNotEmpty) {
                            ...
                            if (avatarUrl != null && avatarUrl.isNotEmpty) {
                              try {
                                await rxImageController
                                    .deleteImageFromBucket(avatarUrl);
                              } catch (e) {
                                debugPrint('Error deleting avatar: $e');
                              }
                            }

                            await rxImageController.uploadAvatar(
                                rxImageController.pickedImages.last);
                          }
                          rxUserController.updateUser(
                            UserModel(
                              id: user!.uid,
                              avatar: rxImageController.pickedImages.isNotEmpty
                                  ? rxImageController.imagesLinks.last
                                  : rxUserController.currentUser.value!.avatar,
                              ...
                              profileComplete: rxUserController
                                  .currentUser.value!.profileComplete,
                            ),
                          );
                        }),
                  )
